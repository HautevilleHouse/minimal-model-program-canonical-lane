...
mkdir -p .repro_tmp/minimal_model_program
cp artifacts/stitch_constants.json .repro_tmp/minimal_model_program/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/minimal_model_program/constants_registry.json
